...
ui <- dashboardPage(skin = "green",
    dashboardHeader(title = "Pathway After SPM"),
    ## Sidebar content
    dashboardSidebar(
        sidebarMenu(
            ...
            menuItem("List of Institutions", tabName = "list", icon = icon("list-alt")),
    ...
    tabItems(
            ...
            tabItem(tabName = "list",
                fluidPage(
                  titlePanel((h1(strong(("List of Institutions")),align="center"))),
                  helpText(h5(strong(
            ...
            tabItem(tabName = "abt",
            fluidPage(
              titlePanel(h1(strong("About"), align = "center")),
