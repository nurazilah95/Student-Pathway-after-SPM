...
ui <- dashboardPage(skin = "green",
    dashboardHeader(title = "Malaysia Universities Ranking"),
    ## Sidebar content
    dashboardSidebar(
        sidebarMenu(
            menuItem("List of Universities", tabName = "list", icon = icon("list-alt")),
            menuItem("Table", tabName = "table", icon = icon("table")),
            menuItem("Plot", tabName = "plot", icon = icon("bar-chart")),
            menuItem("Flow Chart", tabName = "flowchart", icon = icon(name = "sitemap", lib = "font-awesome")),
            menuItem("About", tabName = "abt", icon = icon("book"))
        )
    ),
    ...
    tabItems(
            ...
            # 1st tab content on List of Universities in Malaysia
            tabItem(tabName = "list",
                fluidPage(
                  titlePanel((h1(strong(em("Study Pathway After SPM")),align="center"))),
                  helpText(h5(strong(
                    ...
                    "Have a look at the list of Institution right here!"), style="color:black",align="center")),
            ...
            # 2nd tab content on Table Ranking
            tabItem(tabName = "table",
                fluidPage(
                    titlePanel(h1(("World Ranking"), align = "center")),
                ),
            ...
            # 3rd tab content on Bar Chart
            tabItem(tabName = "plot",
                fluidPage(
                    
                    titlePanel(h1(("Malaysia's University World Ranking"), align = "left")),
                    sidebarLayout(
                        ...
                        conditionalPanel(
                            ...
                            sidebarPanel(
                                ...
                                choices = c("2020", "2019", "2018", "2017", "2016", "2015", "2014", "2013", 
                                            "2012","2011", "2010", "2009", "2008", "2007", "2006", "2005", "2004")),
                                
                                sliderInput("World.Rank", label = "World Rank",
                        ...
                        mainPanel(plotOutput("barplot", width = 12))
            ...
            # 4th tab content on Flow Chart
            tabItem(tabName = "flowchart",
            fluidPage(
              titlePanel(h1(("Flow Chart"), align = "center")),
...
server <- function(input, output) {
  ...
  output$url<-renderUI({
      ...
      body <- dashboardBody(
        fluidRow(
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://hcu.edu.my/course-detail/foundation-mass-communication", h4(strong("Han Chiang College"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://search.hw.ac.uk/s/search.html?collection=malaysia-courses&f.Level%7Ccourselevel=Degree+Entry+%28Foundation%29", h4(strong("Heriot-Watt University"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="http://www.kysnz.edu.my/home/foundation-in-commerce-draft/", h4(strong("KYS Business School"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://www.limkokwing.net/cambodia/academic/courses/", h4(strong("Limkokwing University"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://miu.edu.my/course-listing?field_course_level_tid=9", h4(strong("Manipal Int University"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://www.mckl.edu.my/course/13/Australian-Matriculation-(AUSMAT)/", h4(strong("Methodist College KL"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://www.mmu.edu.my/programmes/", h4(strong("Multimedia University"))),
                   br(),
                   img(src = "MMU.png",width="150px",height="150px") 
                 )
          ),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://www.ncl.ac.uk/numed/study/undergraduate/foundation/#courseoverview", h4(strong("Newcastle University"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://www.perdanauniversity.edu.my/programmes/#1495782292446-4b685137-e4ab", h4(strong("Perdana University"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="http://www.rcsiucd.edu.my/programme/foundation-in-science/", h4(strong("RCSI & UCD MALAYSIA CAMPUS"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://www.segi.edu.my/visit-segi/segi-college-penang", h4(strong("SEGI College Penang"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://segi.edu.my/sarawak/#", h4(strong("SEGI College Sarawak"))),
                   br(),
                   img(src = "SEGI.png",width="150px",height="150px") 
                 )
          ),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://www.segi.edu.my/programmes/pre-u-foundation/", h4(strong("SEGI University & Colleges"))),
                   br(),
                   img(src = "SEGI.png",width="150px",height="150px") 
                 )
          ),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://sunway.edu.my/ipoh/Foundation-in-Arts", h4(strong("Sunway College Ipoh"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://www.nottingham.edu.my/Study/Foundation-courses/UG-Foundation-courses.aspx", h4(strong("University of Nottingham"))),
                   br(),
        ...
        fluidRow(
          ...
          column(width = 2,
                 box(
                   ...
                   br(),
                   img(src = "PutraIntelek.png",width="150px",height="150px") 
                 )
          ),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://www.ramsaysimedarbycollege.edu.my/programmes/", h4(strong("Ramsay Sime Darby"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://www.southern.edu.my/sra/diploma.html", h4(strong("Southern University College"))),
                   br(),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://sunway.edu.my/ipoh/Programmes", h4(strong("Sunway College Ipoh"))),
                   br(),
                   img(src = "Sun_ipoh.png",width="150px",height="150px") 
                 )
          ),
          ...
          column(width = 2,
                 box(
                   status = "warning", width = NULL,
                   tags$a(href="https://swck.edu.my/courses/#", h4(strong("Sunway College Kuching"))),
                   br(),
    ...
    output$barplot <- renderPlot({
        ...
        data %>% select(Year, Institution, World.Rank) %>% 
          group_by(Institution, World.Rank) %>% 
          filter(World.Rank <- input$World.Rank & Year == input$Year) %>% 
          ggplot(aes(x = Institution, y = World.Rank)) + geom_bar(stat = "identity", fill = "blue") +
...
# node definitions with substituted label text
      ...
      tab7 -> tab10 -> tab14[arrowhead = box]
      tab2 -> tab4 -> tab5 -> tab8-> tab11 -> tab15[arrowhead = box]
      tab8 -> tab12 -> tab16[arrowhead = box]
